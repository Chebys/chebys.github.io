...
const POurl='https://cdn.jsdelivr.net/gh/Chebys/chebys.github.io/data/chinese_s.po';//'/data/chinese_s.txt';
var size,date,xhr=new XMLHttpRequest();
var dstSpeech=(await import('/js/modules/dst_speech.js')).default;
